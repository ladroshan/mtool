...
public class Page extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(MTOOL.gridsize.equals("3x3"))
			v = inflater.inflate(R.layout.x33, container, false);
		if(MTOOL.gridsize.equals("3x4"))
			v = inflater.inflate(R.layout.x34, container, false);
		if(MTOOL.gridsize.equals("4x4"))
			v = inflater.inflate(R.layout.x44, container, false);
		if(MTOOL.gridsize.equals("4x5"))
			v = inflater.inflate(R.layout.x45, container, false);
		if(MTOOL.gridsize.equals("5x5"))
			v = inflater.inflate(R.layout.x55, container, false);
		createComponents();
		update();
		return v;
	}
	...
	{
		v.setBackgroundResource((MTOOL.prefs.getBoolean("mainbg_pref", false)) ? R.drawable.mainbg : android.R.color.transparent);
    	...
    	for(int i = 0; i < MTOOL.felder; i++) {
    		...
    		for(int o = 0; o < allItems.length; o++) {
    			allItems[o][i] = new Item(getActivity());
