...
public class ViewPager3D extends ViewPager {
	final static float DEFAULT_OVERSCROLL_ROTATION = 4;
	final static int DEFAULT_OVERSCROLL_TRANSLATION = 50;
	final static int DEFAULT_SWIPE_TRANSLATION = 50;
	final static float DEFAULT_SWIPE_ROTATION = 4;
